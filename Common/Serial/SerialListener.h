...
public :
	...
	BOOL StartListener(LPCTSTR lpszDevice, DWORD dwBaudrate, DWORD dwId = 0, HWND hWnd = NULL, FuncNotifySerialListener Func = NULL, void* pArg = NULL);
	void StopListener();
...
protected:
	...
	HWND	m_hWnd;
	FuncNotifySerialListener m_FuncNotify;
	void*	m_pArg;
