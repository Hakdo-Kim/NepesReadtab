...
public:
	...
	DWORD_PTR GetTotalMilliseconds() const { return m_Milliseconds; }
	DWORD_PTR GetTotalSeconds() const;
	DWORD_PTR GetTotalMinutes() const;
	DWORD_PTR GetTotalHours() const;
	...
	DWORD_PTR GetCurrentMilliseconds() const;
	DWORD_PTR GetCurrentSeconds() const;
	DWORD_PTR GetCurrentMinutes() const;
	DWORD_PTR GetCurrentHours() const;

    // Gets the number of times a timing event has occurred.
	DWORD_PTR GetCount() const { return m_Count; }
