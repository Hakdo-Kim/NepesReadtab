...
DWORD_PTR CMMTimer::GetTotalSeconds() const
{
...
DWORD_PTR CMMTimer::GetTotalMinutes() const
{
...
DWORD_PTR CMMTimer::GetTotalHours() const
{
...
DWORD_PTR CMMTimer::GetCurrentMilliseconds() const
{ 
...
DWORD_PTR CMMTimer::GetCurrentSeconds() const
{
...
DWORD_PTR CMMTimer::GetCurrentMinutes() const
{
...
// every 24 hours).
DWORD_PTR CMMTimer::GetCurrentHours() const
{
	DWORD_PTR CurrentHours = GetTotalHours();
...
// occurs.
void CALLBACK CMMTimer::TimeProc(UINT uTimerID, UINT uMsg, DWORD_PTR dwUser, DWORD_PTR dw1, DWORD_PTR dw2)
{
